...
\begin{flalign*}
  ...
  &\quadfive \{xs \mapsto n, b \mapsto (\pi_0 b, (\pi_1 b, g(\pi_1 b))) \}) \\
  &\quad = (1, \llambda a. \LB (1 + \pi_1\pi_1 b_c) +_c \pi_1\pi_1 b_p\ \T{Cons}\LP \pi_0 b, a \RP \RB \\
...
\begin{flalign*}
  ...
  &= 1 \pplus_c \LB \lambda xs. 1 +_c \T{rec}(xs, \T{Nil} \mapsto \LP 1, \lambda a. \LP 0, a \RP \RP\\
  &\qquad \T{Cons}\mapsto \LP x, \LP xs', r\RP\RP. \LP 1, \lambda a.(1 + r_c) +_c r_p\ \T{Cons}\LP x, a \RP \RP)\ \T{Nil} \RB \{xs \mapsto n\}\ n  \\
  &= 1 \pplus_c (\llambda xs. \LB 1 +_c \T{rec}(xs, \T{Nil} \mapsto \LP 1, \lambda a. \LP 0, a \RP \RP\\
  &\qquad \T{Cons}\mapsto \LP x, \LP xs', r\RP\RP. \LP 1, \lambda a.(1 + r_c) +_c r_p\ \T{Cons}\LP x, a \RP \RP)\ \T{Nil}\RB \{xs \mapsto n\})\ n  \\
  &= 1 \pplus_c (\llambda xs. 1 \pplus_c \LB \T{rec}(xs, \T{Nil} \mapsto \LP 1, \lambda a. \LP 0, a \RP \RP\\
