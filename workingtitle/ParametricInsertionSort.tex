...
\begin{flalign*}
  ...
  f_{Nil}(\ast) &= \llbracket \langle 1,\T{Cons}\langle x,\T{Nil}\rangle\rangle \rrbracket \xi \\
                &= (1, (x, 1)) \\
  f_{Cons}(j,m) &= \llbracket (3 + (f\ x)_c) +_c \T{rec}(((f\ x)_p\ y)_p, \T{True}\mapsto \langle 1, \T{Cons}\langle x,\T{Cons}\langle y,ys\rangle\rangle\rangle, \\
                ...
                &= (3 + (f\ x)_c) \pplus_c \llbracket\T{rec}(((f\ x)_p\ y)_p, \T{True}\mapsto \langle 1, \T{Cons}\langle x,\T{Cons}\langle y,ys\rangle\rangle\rangle, \\
                &\quadthree \T{False}\mapsto \langle 1 + r_c, \T{Cons}\langle y,r_p\rangle\rangle)\rrbracket \xi \{ y \mapsto j, ys \mapsto (j, m), r \mapsto g(j, m)\} \\
...
%
\begin{flalign*}
  \|\T{insert}\| &= (0, \llambda f.(0,\llambda x.(0,\llambda (i,n).g(i,n)))) %include x in g?
\end{flalign*}
%
%\begin{figure}[H]
...
%
%       $f_{Cons}((j,(j,m))) = (4 + \pi_0(\pi_1(f\ x)\ j) + \pi_0g(j,m), (max\{x,j\pi_0\pi_1g(j,m)\}, 2+m \vee 1 + \pi_1\pi_1g(j,m)))$
%
  ...
  \begin{description}
    ...
    \item[case$n>0$]\hfill \\
      \begin{flalign*}
        ...
        &= \bigvee_{j < i, m \leq n \text{ or } j \leq i, m < n} 3 + ((f\ x)_p\ j)_c + g_c(j, m')) &&\text{where $m' = m - 1$}\\
        &= \bigvee_{j < i, m \leq n \text{ or } j \leq i, m < n} 3 + ((f\ x)_p\ j)_c + (3 + ((f\ x)_p\ j)_c)m' + 1 &&\text{by the induction hypothesis}\\
        &= \bigvee_{j < i, m \leq n \text{ or } j \leq i, m < n} (3 + ((f\ x)_p\ j)_c) (m' + 1) + 1 &&\\
        &= \bigvee_{j < i, m \leq n \text{ or } j \leq i, m < n} (3 + ((f\ x)_p\ j)_c) m + 1 &&\\
        &\leq \bigvee_{i < j, m \leq n \text{ or } i \leq j, m < n} (3 + ((f\ x)_p\ i)_c) n + 1 &&\\
  ...
  \begin{description}
    ...
    \item[case $n>0$] \hfill \\
      \begin{flalign*}
        ...
        &= \bigvee_{j < i, m \leq n \text{ or } j \leq i, m < n} 3 + \pi_0 g(j, m - 1) + \pi_0(insert\ f\ j\ \pi_1g(j, m - 1))\\
        &\leq \bigvee_{j < i, m \leq n \text{ or } j \leq i, m < n} 3 + \pi_0 g(j, m - 1) + \pi_0(insert\ f\ j\ (j, m - 1))\\
        &\leq \bigvee_{j < i, m \leq n \text{ or } j \leq i, m < n} 3 + \pi_0 g(j, m - 1) + (3 + \pi_0(\pi_1(f\ j)\ j))(m - 1) + 1\\
        & \text{let $c_1 = (3 + \pi_0(\pi_1(f\ j)\ j))$}\\
        &\leq \bigvee_{j < i, m \leq n \text{ or } j \leq i, m < n} 3 + c_1(m-1)^2 + 5(m-1) + 1 + c_1(m - 1) + 1\\
        &\leq \bigvee_{j < i, m \leq n \text{ or } j \leq i, m < n} 3 + c_1m^2 - 2c_1m +c_1 + 5m-5 + 1 + c_1m - c_1 + 1\\
        &\leq \bigvee_{j < i, m \leq n \text{ or } j \leq i, m < n} c_1m^2 - c_1m + 5m + 1\\
        &\leq \bigvee_{j < i, m \leq n \text{ or } j \leq i, m < n} (3 + \pi_0(\pi_1(f\ i)\ i))n^2 + 5n + 1\\
