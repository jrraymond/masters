...
structural list recursion, referred to as the source langugage. The recurrences
for the cost of evaluating source language programs are constructed by
translating the source language into a complexity language.
